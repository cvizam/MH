...
# EJECUCIÓN DEL ALGORITMO GENÉTICO GENERACIONAL
# ¡ PARA SU EJECUCIÓN, DESCOMENTAR SEGÚN EL TIPO DE CRUCE QUE QUIERA !

tasa_clas, tasa_red, agregado, times = AGG(x,y,'BLX')
#tasa_clas, tasa_red, agregado, times = AGG(x,y,'CA')
display_table(tasa_clas,tasa_red,agregado,times)

# EJECUCIÓN DEL ALGORITMO GENÉTICO ESTACIONARIO
# ¡ PARA SU EJECUCIÓN, DESCOMENTAR SEGÚN EL TIPO DE CRUCE QUE QUIERA !

#tasa_clas, tasa_red, agregado, times = AGE(x,y,'BLX')
#tasa_clas, tasa_red, agregado, times = AGE(x,y,'CA')
#display_table(tasa_clas,tasa_red,agregado,times)

# EJECUCIÓN DEL ALGORITMO MEMÉTICO
# DESCOMENTAR OPCIÓN DESEADA. OPCIONES:
# 1. AM-(10,1.0)
# 2. AM-(10,0.1)
# 3. AM-(10,0.1mej)

#tasa_clas, tasa_red, agregado, times = AM(x,y,10,1)
#tasa_clas, tasa_red, agregado, times = AM(x,y,10,2)
#tasa_clas, tasa_red, agregado, times = AM(x,y,10,3)
#display_table(tasa_clas,tasa_red,agregado,times)
